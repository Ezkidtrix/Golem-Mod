...
public class IceMiniGolemModel<T extends IceMiniGolemEntity> extends EntityModel<T> {
	private final ModelPart golem;

	public IceMiniGolemModel(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData right_arm = golem.addChild("right_arm", ModelPartBuilder.create().uv(60, 21).cuboid(-2.0F, 0.5F, -3.0F, 4.0F, 13.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-11.0F, -18.0F, 0.0F));

		ModelPartData left_arm = golem.addChild("left_arm", ModelPartBuilder.create().uv(60, 58).cuboid(-2.0F, 0.5F, -3.0F, 4.0F, 13.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(11.0F, -18.0F, 0.0F));
